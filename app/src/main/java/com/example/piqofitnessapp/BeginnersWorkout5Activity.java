...
public class BeginnersWorkout5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beginners_workout5);
        ...
        textToSpeech = new TextToSpeech(BeginnersWorkout5Activity.this, new TextToSpeech.OnInitListener() {
            @Override
