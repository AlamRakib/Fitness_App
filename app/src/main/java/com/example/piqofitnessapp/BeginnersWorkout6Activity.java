...
public class BeginnersWorkout6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beginners_workout6);
        ...
        textToSpeech = new TextToSpeech(BeginnersWorkout6Activity.this, new TextToSpeech.OnInitListener() {
            @Override
