...
public class BeginnerWorkout2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beginner_workout2);
        ...
        lottieAnimationView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(lottieAnimationView.getTag()!=null && lottieAnimationView.getTag().toString().contains("NOT_PLAYING")) {
                    ...
                    mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.basicworkout2);
                    mediaPlayer.start();
        ...
        textToSpeech = new TextToSpeech(BeginnerWorkout2Activity.this, new TextToSpeech.OnInitListener() {
            @Override
