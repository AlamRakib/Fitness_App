...
public class BeginnersWorkout3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beginners_workout3);
        ...
        lottieAnimationView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(lottieAnimationView.getTag()!=null && lottieAnimationView.getTag().toString().contains("NOT_PLAYING")) {
                    ...
                    mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.exercise3);
                    mediaPlayer.start();
        ...
        textToSpeech = new TextToSpeech(BeginnersWorkout3Activity.this, new TextToSpeech.OnInitListener() {
            @Override
