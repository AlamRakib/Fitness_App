...
public class WorkoutTimerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lottieAnimationView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(lottieAnimationView.getTag()!=null && lottieAnimationView.getTag().toString().contains("NOT_PLAYING")) {
                    ...
                    mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.exercise);
                    mediaPlayer.start();
        ...
        textToSpeech = new TextToSpeech(WorkoutTimerActivity.this, new TextToSpeech.OnInitListener() {
            @Override
